...
- Typography scale: 14/16/18/24/32/40 | Fonts: primary=Noto Sans, display=Fascinate, mono=Fira Code | weights=Noto Sans 100/200/300/400/500/600/700/800/900; Fascinate 400; Fira Code 300/400/500/600/700 (as shipped on Google Fonts, checked 2026-09-20)
...
- Font source: https://fonts.google.com/specimen/Noto+Sans, https://fonts.google.com/specimen/Fascinate, https://fonts.google.com/specimen/Fira+Code
- Font loading: self-host the woff2 from the specimen page rather than linking fonts.googleapis.com (a visitor's IP reaches Google before the page paints). One @font-face per weight actually used, for example:
  ...
  ```css
  @font-face { font-family: "Noto Sans"; font-weight: 100 900; font-style: normal; font-display: swap; src: url("/fonts/noto-sans.woff2") format("woff2"); }
  ```

  The stylesheet Google would serve, if linking it is acceptable for the project: https://fonts.googleapis.com/css2?family=Noto+Sans:wght@100;200;300;400;500;600;700;800;900&family=Fascinate:wght@400&family=Fira+Code:wght@300;400;500;600;700&display=swap
