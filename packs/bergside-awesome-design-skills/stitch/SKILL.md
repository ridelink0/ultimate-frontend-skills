...
- Typography scale: desktop-first expressive scale | Fonts: primary=Ubuntu, display=Oswald, mono=Ubuntu Mono | weights=Ubuntu 300/400/500/700; Oswald 200/300/400/500/600/700; Ubuntu Mono 400/700 (as shipped on Google Fonts, checked 2026-09-20)
...
- Font source: https://fonts.google.com/specimen/Ubuntu, https://fonts.google.com/specimen/Oswald, https://fonts.google.com/specimen/Ubuntu+Mono
- Font loading: self-host the woff2 from the specimen page rather than linking fonts.googleapis.com (a visitor's IP reaches Google before the page paints). One @font-face per weight actually used, for example:
  ...
  ```css
  @font-face { font-family: "Ubuntu"; font-weight: 300 700; font-style: normal; font-display: swap; src: url("/fonts/ubuntu.woff2") format("woff2"); }
  ```

  The stylesheet Google would serve, if linking it is acceptable for the project: https://fonts.googleapis.com/css2?family=Ubuntu:wght@300;400;500;700&family=Oswald:wght@200;300;400;500;600;700&family=Ubuntu+Mono:wght@400;700&display=swap
