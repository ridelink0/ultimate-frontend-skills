...
- Typography scale: desktop-first expressive scale | Fonts: primary=Press Start 2P, display=Press Start 2P, mono=Space Mono | weights=Press Start 2P 400; Space Mono 400/700 (as shipped on Google Fonts, checked 2026-09-20)
...
- Font source: https://fonts.google.com/specimen/Press+Start+2P, https://fonts.google.com/specimen/Space+Mono
- Font loading: self-host the woff2 from the specimen page rather than linking fonts.googleapis.com (a visitor's IP reaches Google before the page paints). One @font-face per weight actually used, for example:
  ...
  The stylesheet Google would serve, if linking it is acceptable for the project: https://fonts.googleapis.com/css2?family=Press+Start+2P:wght@400&family=Space+Mono:wght@400;700&display=swap
